Shader "My Shader/AlphaBlendZWrite"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass 
		{
			...
			v2f vert(a2v v)
			{
				...
				o.worldNormal = UnityObjectToWorldNormal(v.normal);//顶点转换
			...
			fixed4 frag(v2f i) : SV_TARGET
			{
				...
				float4 texColor = tex2D(_MainTex,i.uv);//贴图采样
